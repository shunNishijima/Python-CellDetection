...
scores_all = {}
pool = ModelPool(f"C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/models", FitnessAP(), regex="*/elite.json")
dataset = read_dataset(f"C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/dataset", counting=True)
annotations_test = 0
...
pd.DataFrame(scores_all).to_csv("C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/results/results.csv", index=False)
