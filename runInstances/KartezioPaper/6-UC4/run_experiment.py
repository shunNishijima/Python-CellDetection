...
infos = ProfilingInfo("C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/dataset/META.json")
...
if __name__ == "__main__":
    dataset = read_dataset("C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/dataset")
    # Load Kartezio Model
    model = KartezioModel(
        "C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/models/455116-9d3877fd-8905-4b9a-aa58-56957e76e8d2/elite.json", FitnessAP()
    )
    ...
    model_introspection = KartezioModel(
        "C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/models/34097-86a0cf2a-ecf9-474e-a6a8-b619a08b4202/elite.json", FitnessAP()
    )
    ...
    # Load raw images
    batch_directory = Directory("C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/dataset")
    ...
    for image_name, p in pred_batch.items():
        ...
        visual_image = imread_color(
            "C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/dataset/" + image_name.replace(".tif", ".png"),
            rgb=True,
        )
    ...
    with plt.style.context(["science", "nature"]):
        ...
        ax.legend()
        ax.set(**pparam)
        fig.savefig("C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/results/CTL_Target.png", dpi=300)
    ...
    for image_name in list(batch.keys()):
        filename = f"C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/results/kartezio_classes_{image_name.replace('.tif', '.png')}"
