...
DATASET = "C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/dataset"
OUTPUT = "C:/Module9/Project/module9-dsai/runInstances/KartezioPaper/6-UC4/models"
CHANNELS = [1, 2]
