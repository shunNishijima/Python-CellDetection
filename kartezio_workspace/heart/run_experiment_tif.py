...
from numena.io.image import imread_grayscale, imread_tiff
from sklearn import mixture
from sklearn.decomposition import PCA
from sklearn.preprocessing import StandardScaler
from train_models_tif import preprocessing
import os

infos = ProfilingInfo("C:/Module9/Project/module9-dsai/kartezio_workspace/heart/dataset_tif/META.json")
...
if __name__ == "__main__":
    dataset = read_dataset("C:/Module9/Project/module9-dsai/kartezio_workspace/heart/dataset_tif")
    # Load Kartezio Model
    model = KartezioModel(
        "C:/Module9/Project/module9-dsai/kartezio_workspace/heart/models/414742-95c92ff4-8545-43bc-a143-62afaf0a5f56/elite.json", FitnessAP()
    )
    ...
    model_introspection = KartezioModel(
        "C:/Module9/Project/module9-dsai/kartezio_workspace/heart/models/510173-b8e172a8-081f-47cd-b834-dcf88ad30215/elite.json", FitnessAP()
    )
    ...
    # Load raw images
    batch_directory = Directory("C:/Module9/Project/module9-dsai/kartezio_workspace/heart/dataset_tif")
    ...
    for image_name, p in pred_batch.items():
        if "NP" in image_name:
            ...
            condition = "P"
        labels = p["labels"]
        png_file_path = "C:/Module9/Project/module9-dsai/kartezio_workspace/heart/dataset_tif/" + image_name
        visual_image = imread_grayscale(png_file_path)
    ...
    for image_name in list(batch.keys()):
        filename = f"C:/Module9/Project/module9-dsai/kartezio_workspace/heart/results/kartezio_classes_{image_name.replace('.tif', '.png')}"
